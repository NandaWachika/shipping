...
//rest api to get a single order data 1
...
//rest api to get a add order data 2
...
app.post('/api/schedule/store', function (req, res) {
  var params  = req.body;
  console.log(params);
  connection.query('INSERT INTO schedule SET ?', params, function (error, results, fields) {
    try {
      res.send({
          statusCode: 200,
          statusMessage: 'Ok',
